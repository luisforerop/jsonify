...
- FROM: `### Requirement: Create a project`
- TO: `### Requirement: Create a collection`

- FROM: `### Requirement: List and open projects`
- TO: `### Requirement: List and open collections`

- FROM: `### Requirement: Rename a project`
- TO: `### Requirement: Rename a collection`

- FROM: `### Requirement: Delete a project and its associated data`
- TO: `### Requirement: Delete a collection and its associated data`

- FROM: `### Requirement: Navigate within a project's workspace`
- TO: `### Requirement: Navigate within an open collection`

- FROM: `### Requirement: Manage projects through a persistence boundary`
- TO: `### Requirement: Manage collections through a persistence boundary`
